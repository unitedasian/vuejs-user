(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("vue-authenticate"), require("vue-axios"), require("vue"), require("vue-ls"));
	else if(typeof define === 'function' && define.amd)
		define(["vue-authenticate", "vue-axios", "vue", "vue-ls"], factory);
	else if(typeof exports === 'object')
		exports["uam-vue-user"] = factory(require("vue-authenticate"), require("vue-axios"), require("vue"), require("vue-ls"));
	else
		root["uam-vue-user"] = factory(root["vue-authenticate"], root["vue-axios"], root["vue"], root["vue-ls"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_129__, __WEBPACK_EXTERNAL_MODULE_130__, __WEBPACK_EXTERNAL_MODULE_32__, __WEBPACK_EXTERNAL_MODULE_118__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_efe9d588_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Loading_vue__ = __webpack_require__(103);
var disposed = false
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Loading__ = __webpack_require__(52);
//
//
//
//
  ...
  methods: {
    authenticate: function authenticate(provider) {
      ...
      this.$auth.authenticate(provider).then(function (authResponse) {
        _this.$uamAuth.loginWithToken(authResponse.data).then(function () {
          _this.$emit('login-success', { social: true });
        }).catch(function () {
          _this.$emit('login-error', { message: _this.$i18n.t('user.login.notifyLabel.unknownError') });
        });
      }, function (error) {
        if (error.message === 'Network Error') {
          _this.$emit('login-error', { message: _this.$i18n.t('user.login.notifyLabel.cannotconnect') });
        }
      });
    },
    onSubmit: function onSubmit() {
      ...
      this.$validator.validateAll().then(function (result) {
        if (result) {
          _this2.$emit('before-login');

          _this2.$uamAuth.login(_this2.credentials).then(function () {
            _this2.$emit('login-success', { social: false });
          }).catch(function (error) {
            _this2.credentials.password = '';
            if (error.response && error.response.status === 401) {
              _this2.$emit('login-error', { message: _this2.$i18n.t('user.login.notifyLabel.unauthorized') });
            } else {
              _this2.$emit('login-error', { message: _this2.$i18n.t('user.login.notifyLabel.cannotconnect') });
            }
          });
        }
      });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__models_Profile__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_User__ = __webpack_require__(56);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data: function data() {
    return {
      ...
      profile: new __WEBPACK_IMPORTED_MODULE_0__models_Profile__["a" /* default */](this.$uamAuth.user.profile.state),
      scope: {
        credentials: 'user',
        profile: 'profile'
      },
      user: new __WEBPACK_IMPORTED_MODULE_1__models_User__["a" /* default */](this.$uamAuth.user.state)
    };
  },
  ...
  methods: {
    ...
    updateProfile: function updateProfile() {
      ...
      this.$uamAuth.updateProfile({ profile: this.profile.state }, this.updateUrl).then(function () {
        _this2.$emit('update-success', { message: _this2.$i18n.t('user.profile.notifyLabel.updated') });
      }).catch(function (error) {
        if (error.response && error.response.status === 401) {
          _this2.$uamAuth.refreshToken().then(function () {
            _this2.$uamAuth.updateProfile({ profile: _this2.profile.state }, _this2.updateUrl).then(function () {
              _this2.$emit('update-success', { message: _this2.$i18n.t('user.profile.notifyLabel.updated') });
            });
          }).catch(function (error) {
            if (error.response.status === 401) {
              ...
              _this2.$emit('update-error', { message: _this2.$i18n.t('user.profile.notifyLabel.cannotrefresh') });
            }
          });
        } else if (error.response && error.response.status === 422) {
          _this2.$emit('update-error', { message: _this2.$i18n.t('user.profile.notifyLabel.validationError') });
        } else {
          _this2.$emit('update-error', { message: _this2.$i18n.t('user.profile.notifyLabel.cannotconnect') });
        }
      });
    },
    updateUser: function updateUser() {
      ...
      this.$uamAuth.updateUser({ user: this.user.state }, this.updateUrl).then(function () {
        _this3.$emit('update-success', { message: _this3.$i18n.t('user.profile.notifyLabel.updated') });
      }).catch(function (error) {
        if (error.response && error.response.status === 401) {
          _this3.$uamAuth.refreshToken().then(function () {
            _this3.$uamAuth.updateUser({ user: _this3.user.state }, _this3.updateUrl).then(function () {
              _this3.$emit('update-success', { message: _this3.$i18n.t('user.profile.notifyLabel.updated') });
            });
          }).catch(function (error) {
            if (error.response.status === 401) {
              ...
              _this3.$emit('update-error', { message: _this3.$i18n.t('user.profile.notifyLabel.cannotrefresh') });
            }
          });
        } else if (error.response && error.response.status === 422) {
          _this3.$emit('update-error', { message: _this3.$i18n.t('user.profile.notifyLabel.uniqueEmail') });
        } else {
          _this3.$emit('update-error', { message: _this3.$i18n.t('user.profile.notifyLabel.cannotconnect') });
        }
      });
    }
  },
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return UPDATE_REQUEST_PENDING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return UPDATE_SOCIAL_AUTH_PENDING; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__authenticator__ = __webpack_require__(91);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_User__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__router__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__store__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_authenticate__ = __webpack_require__(129);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_vue_axios__ = __webpack_require__(130);
...
var VuePlugin = {
  ...
  install: function install(Vue) {
    ...
    var userModule = Object(__WEBPACK_IMPORTED_MODULE_6__store__["a" /* default */])({ axios: axios, userModel: userModel, profileModel: profileModel, localStorageNamespace: localStorageNamespace });
...
var Authenticator = function () {
  ...
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(Authenticator, [{
    ...
    key: 'updateProfile',
    value: function updateProfile(profile, updateUrl) {
      return this.store.dispatch(this.namespace + '/updateProfile', { profile: profile, updateUrl: updateUrl });
    }
  }, {
    key: 'updateUser',
    value: function updateUser(user, updateUrl) {
      return this.store.dispatch(this.namespace + '/updateUser', { user: user, updateUrl: updateUrl });
    }
  }, {
    key: 'user',
    get: function get() {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Loading_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Login_vue__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Profile_vue__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__UserMenu_vue__ = __webpack_require__(112);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "uamLoading", function() { return __WEBPACK_IMPORTED_MODULE_0__Loading_vue__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "uamLogin", function() { return __WEBPACK_IMPORTED_MODULE_1__Login_vue__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Login_vue__ = __webpack_require__(54);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ef68022e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Login_vue__ = __webpack_require__(107);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Profile_vue__ = __webpack_require__(55);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bf1681ae_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Profile_vue__ = __webpack_require__(111);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_UserMenu_vue__ = __webpack_require__(57);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_53e47a0c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_UserMenu_vue__ = __webpack_require__(113);
var disposed = false
var normalizeComponent = __webpack_require__(10)
/* script */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modules_login_Index__ = __webpack_require__(115);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7372988a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Index_vue__ = __webpack_require__(116);
var disposed = false
var normalizeComponent = __webpack_require__(10)
/* script */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_ls__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__getters__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mutations__ = __webpack_require__(128);
...
/* harmony default export */ __webpack_exports__["a"] = (function (options) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_ls___default.a, storageOptions);

  var axios = options.axios;
  var profileModel = options.profileModel;
  var userModel = options.userModel;

  axios.defaults.headers.common['Authorization'] = 'Bearer ' + __WEBPACK_IMPORTED_MODULE_0_vue___default.a.ls.get('access_token');
  axios.defaults.withCredentials = true;

  var state = {
    isLoggedIn: !!__WEBPACK_IMPORTED_MODULE_0_vue___default.a.ls.get('access_token'),
    tokenExpiresAt: __WEBPACK_IMPORTED_MODULE_0_vue___default.a.ls.get('access_token_expire'),
    isRefreshExpired: __WEBPACK_IMPORTED_MODULE_0_vue___default.a.ls.get('is_refresh_expired'),
    user: __WEBPACK_IMPORTED_MODULE_0_vue___default.a.ls.get('user'),
    pending: false,
    locale: 'en',
  ...
  return {
    actions: Object(__WEBPACK_IMPORTED_MODULE_3__actions__["a" /* default */])(axios),
    getters: Object(__WEBPACK_IMPORTED_MODULE_2__getters__["a" /* default */])({ profileModel: profileModel, userModel: userModel }),
...
var isRefreshExpired = function isRefreshExpired(state) {
  return state.isRefreshExpired;
};

var isRequestPending = function isRequestPending(state) {
  return state.isRequestPending;
};

var isSocialAuthPending = function isSocialAuthPending(state) {
...
var tokenExpiresAt = function tokenExpiresAt(state) {
...
/* harmony default export */ __webpack_exports__["a"] = (function (options) {
  ...
  return {
    ...
    isSocialAuthPending: isSocialAuthPending,
    locale: locale,
    profile: profile,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mutation_types__ = __webpack_require__(59);
...
/* harmony default export */ __webpack_exports__["a"] = (function (axios) {
  var login = function login(_ref, payload) {
    var commit = _ref.commit;

    commit(__WEBPACK_IMPORTED_MODULE_3__mutation_types__["a" /* LOGIN */]);
    ...
    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      axios.post(payload.loginUrl, payload.credentials).then(function (response) {
        ...
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('access_token_expire', expireUtcTime - transmissionLagDuration);
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('access_token', response.data.access_token);
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('is_refresh_expired', false);

        axios.defaults.headers.common['Authorization'] = 'Bearer ' + __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('access_token');
        ...
        axios.all([axios.get(payload.currentUserUrl)]).then(function (_ref2) {
          ...
          __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('user', userResponse.user);

          commit(__WEBPACK_IMPORTED_MODULE_3__mutation_types__["b" /* LOGIN_SUCCESS */]);
          resolve();
        }).catch(function (error) {
          reject(error);
        });
  ...
  var loginWithToken = function loginWithToken(_ref4, payload) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      ...
      __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('access_token_expire', expireUtcTime - transmissionLagDuration);
      __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('access_token', payload.token.access_token);
      __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('is_refresh_expired', false);

      axios.defaults.headers.common['Authorization'] = 'Bearer ' + __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('access_token');

      axios.get(payload.currentUserUrl).then(function (response) {
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('user', response.data.user);
  ...
  var logout = function logout(_ref5, payload) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve) {
      axios.post(payload.logoutUrl).then(function (response) {
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.clear();

        delete axios.defaults.headers.common['Authorization'];

        commit(__WEBPACK_IMPORTED_MODULE_3__mutation_types__["c" /* LOGOUT */]);
        resolve();
      }).catch(function (error) {
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.clear();
  ...
  var refreshToken = function refreshToken(_ref6, payload) {
    ...
    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      ...
      axios.post(payload.refreshUrl).then(function (response) {
        ...
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.clear();
        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('is_refresh_expired', true);
  ...
  var updateProfile = function updateProfile(_ref7, payload) {
    var commit = _ref7.commit;

    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      axios.put(payload.updateUrl, payload.profile).then(function (response) {
        var user = __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('user');

        user.profile = response.data.profile;

        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('user', user);
        commit(__WEBPACK_IMPORTED_MODULE_3__mutation_types__["d" /* UPDATE_PROFILE */], response.data.profile);
        resolve();
      }).catch(function (error) {
        reject(error);
      });
  ...
  var updateRequestPending = function updateRequestPending(_ref8, isRequestPending) {
    var commit = _ref8.commit;

    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve) {
      commit(__WEBPACK_IMPORTED_MODULE_3__mutation_types__["e" /* UPDATE_REQUEST_PENDING */], { isRequestPending: isRequestPending });
      resolve();
    });
  };

  var updateSocialAuthPending = function updateSocialAuthPending(_ref9, isSocialAuthPending) {
    var commit = _ref9.commit;

    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve) {
      commit(__WEBPACK_IMPORTED_MODULE_3__mutation_types__["f" /* UPDATE_SOCIAL_AUTH_PENDING */], { isSocialAuthPending: isSocialAuthPending });
      resolve();
    });
  };

  var updateUser = function updateUser(_ref10, payload) {
    var commit = _ref10.commit;

    return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      axios.put(payload.updateUrl, payload.user).then(function (response) {
        var updatedUser = response.data;

        if (!updatedUser.profile) {
          updatedUser.profile = __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('user').profile;
        }

        __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.set('user', updatedUser);
        commit(__WEBPACK_IMPORTED_MODULE_3__mutation_types__["g" /* UPDATE_USER */], updatedUser);
        resolve();
      }).catch(function (error) {
        reject(error);
      });
  ...
  return {
    ...
    updateRequestPending: updateRequestPending,
    updateSocialAuthPending: updateSocialAuthPending,
...
/* harmony default export */ __webpack_exports__["a"] = (_types$LOGIN$types$LO = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$LOGIN$types$LO, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["a" /* LOGIN */], function (state) {
  state.pending = true;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$LOGIN$types$LO, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["b" /* LOGIN_SUCCESS */], function (state) {
  state.tokenExpiresAt = __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('access_token_expire');
  state.isRefreshExpired = __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('is_refresh_expired');
  state.user = __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('user');
  state.isLoggedIn = true;
  state.pending = false;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$LOGIN$types$LO, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["c" /* LOGOUT */], function (state) {
  state.tokenExpiresAt = null;
  state.isRefreshExpired = __WEBPACK_IMPORTED_MODULE_2_vue___default.a.ls.get('is_refresh_expired');
  state.user = null;
  state.isLoggedIn = false;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$LOGIN$types$LO, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["d" /* UPDATE_PROFILE */], function (state, profile) {
  state.user.profile = profile;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$LOGIN$types$LO, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["e" /* UPDATE_REQUEST_PENDING */], function (state, payload) {
  state.isRequestPending = payload.isRequestPending;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$LOGIN$types$LO, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["f" /* UPDATE_SOCIAL_AUTH_PENDING */], function (state, payload) {
  state.isSocialAuthPending = payload.isSocialAuthPending;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$LOGIN$types$LO, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["g" /* UPDATE_USER */], function (state, user) {
  state.user = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, state.user, user);
